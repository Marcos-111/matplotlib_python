...
def ej1():
    ...
    ax.plot(x, y, color='r', label= "y1 = x**2")       
...
def ej2():
    ...
    ax.plot(x, y1, color='y', label= "y1 = x**2")
    ax.plot(x, y2, color='g', label= "y2 = x**3")        
...
def ej3():
    ...
    ax1.scatter(x, y, color='purple', marker= 'x')
...
def ej4():
    ...
    ax4.plot(x, y4, color='green', label='y4 = np.sqrt(x)')
